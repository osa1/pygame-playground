...
if __name__ == "__main__":
    ...
    while running:
        ...
        m1 = vektorler[0][0]*uzunluk+pos, -vektorler[0][1]*uzunluk+pos
        m2 = vektorler[1][0]*uzunluk+pos, -vektorler[1][1]*uzunluk+pos
        m3 = r[0]*uzunluk+pos, -r[1]*uzunluk+pos
        m4 = -r[0]*uzunluk+pos, r[1]*uzunluk+pos
        #print "-----------------------------------------------------------------"
        #print m1
        #print m2
        #print m3
